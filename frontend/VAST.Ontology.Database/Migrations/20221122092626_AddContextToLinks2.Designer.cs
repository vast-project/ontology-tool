...
namespace VAST.Ontology.Database.Migrations
{
    ...
    [Migration("20221122092626_AddContextToLinks2")]
    partial class AddContextToLinks2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ContextItem", b =>
                {
                    b.Property<int>("ContextsId")
                        .HasColumnType("integer");

                    b.Property<int>("SecondaryItemsId")
                        .HasColumnType("integer");

                    b.HasKey("ContextsId", "SecondaryItemsId");

                    b.HasIndex("SecondaryItemsId");

                    b.ToTable("ContextItem");
                });
            ...
            modelBuilder.Entity("ContextItem", b =>
                {
                    b.HasOne("VAST.Ontology.Database.Models.Context", null)
                        .WithMany()
                    ...
                    b.HasOne("VAST.Ontology.Database.Models.Item", null)
                        .WithMany()
                        .HasForeignKey("SecondaryItemsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
